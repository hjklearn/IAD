...
if __name__ == '__main__':
    ...
    parser.add_argument('--output_dir', type=str, default='/media/lai/data_h/hjk/医学图像分割/Other_dataset/KD_model/Pth_teacher_10pct/pre512')
    ...
    parser.add_argument('--ckpt', type=str, default='/media/lai/data_h/hjk/医学图像分割/Other_dataset/KD_model/segment_anything_Tea/sam_vit_l_0b3195.pth',
                        help='Pretrained checkpoint')
    parser.add_argument('--lora_ckpt', type=str, default='/media/lai/data_h/hjk/医学图像分割/Other_dataset/KD_model/Pth_teacher_10pct/Synapse_512_pretrain_vit_l_epo300_bs8_lr0.0026_s2345/epoch_299.pth', help='The checkpoint from LoRA')
