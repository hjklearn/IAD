...
import torch
import itertools
from .utils_levit import replace_batchnorm
...
def LeViT_128S(num_classes=1000, distillation=False,
...
def LeViT_128(num_classes=1000, distillation=False,
              pretrained=False, pretrained_cfg=None, fuse=False):
...
if __name__ == '__main__':
    net = LeViT_128S(fuse=True, pretrained=True)
