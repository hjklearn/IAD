...
class MobileNetV2(nn.Module):
    ...
    def _forward_impl(self, x):
        ...
        # x = self.classifier(x)
        local_fea.append(out2)
        local_fea.append(out3)
        local_fea.append(out4)
        local_fea.append(out5)
        return out5, local_fea
...
def mobilenet_v2(pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        print('mobilenet_v2 pretrain loading!!!')
        model_dict = {}
...
if __name__=='__main__':
    ...
    out, local_fea = model(rgb)
    for i in range(len(local_fea)):
        print(local_fea[i].shape)
    print(out.shape)